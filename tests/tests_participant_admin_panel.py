...
class TestParticipantsPageOfTheAdminPanel:
    data_for_create_participant_admin = [
        ("Anastasia", "Luzina", 1, "+380999999999", "testing@gmail.com", "Valid comment", "anastasiia#1234",
         "https://www.linkedin.com/in/anastasiia", "city", True, 1, "QA Manual", 201),
        ("A", "Luzina", 1, "+380999999999", "testing@gmail.com", "Valid comment", "anastasiia#1234",
         "https://www.linkedin.com/in/anastasiia", "city", True, 1, "QA Manual", 400),
        ("A" * 21, "Luzina", 1, "+380999999999", "testing@gmail.com", "Valid comment", "anastasiia#1234",
         "https://www.linkedin.com/in/anastasiia", "city", True, 1, "QA Manual", 400),
    ]
    ...
    @pytest.mark.parametrize(
        ...
        data_for_create_participant_admin, ids=ids_for_data_for_create_participant_admin)
    def test_create_participant(self, token, first_name, last_name, speciality, phone_number, email, comment,
                                account_discord, account_linkedin, city, experience, project, stack,
    ...
    data = [("Anna", "Luzina", 1, "+380999999999", "testing@gmail.com", "Valid comment", "anastasiia#1234",
             "https://www.linkedin.com/in/anastasiia", "city", True, 1, "QA Manual", 201)]
    ids_for_update = ["test"]

    @pytest.mark.parametrize(
        "first_name, last_name, speciality, phone_number, email, comment, account_discord, account_linkedin, city,"
        " experience, project, stack, status_code", data, ids=ids_for_update)
    def test_update_participant(self, token, create_participant, first_name, last_name, speciality, phone_number,
                                email, comment, account_discord, account_linkedin, city, experience, project, stack,
                                status_code):
