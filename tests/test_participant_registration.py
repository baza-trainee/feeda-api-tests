...
class TestParticipantRegistration:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("", "", "", "", "", "", "", "", True, 1, True, True, "Regular", 400,
            ...
            pytest.param("JohnJohJohnJohnJohnJ", "Smith", "Frontend", "+380999999999", "john@example.com", "john#5678",
                         "https://www.linkedin.com/johnsmith", "San Francisco", True, 1, True, True, "VIP", 400,
            ...
            pytest.param("Jane", "D", "Full Stack", "+380999999999", "jane@example.com", "jane#5678",
                         ...
                         "San Francisco", True, 1, True, True, "Regular", 400,
                         id="test_invalid_last_name_min_length"),

            pytest.param(
                "Alice", "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz", "AI", "+380999999999",
                "alice@example.com",
                "alice#4321", "https://www.linkedin.com/alice", "Los Angeles", True, 1, True, True, "Regular", 400,
                id="test_invalid_last_name_max_length"),

            pytest.param("Mike", "Johnson", "U", "+380999999999", "mike@example.com", "mike#9876",
                         "https://www.linkedin.com/mikejohnson", "Chicago", True, 1, True, True, "Regular", 400,
                         id="test_invalid_stack_min_length"),

            pytest.param("Eve", "Smith", "Development" + "a" * 292, "+380999999999", "eve@example.com", "eve#5678",
                         "https://www.linkedin.com/evesmith", "Seattle", True, 1, True, True, "Regular", 400,
            ...
            pytest.param("Alex", "Brown", "IT", "+380999999999", "alex@example.com", "alex#5678",
                         "https://www.linkedin.com/a" + "a" * 10, "San Francisco", True, 1, True, True, "Regular",
                         400,
            ...
            pytest.param("David", "Smith", "Analytics", "+380999999999", "david@example.com", "david#5678",
                         "https://www.linkedin.com/davidsmith", "New York", None, 1, True, True, "Regular", 400,
            ...
            pytest.param("David", "Smith", "Analytics", "+380999999999", "david@example.com", "david#5678",
                         "https://www.linkedin.com/davidsmith", "New York", True, 4, True, True, "Regular", 400,
                         id="test_invalid_type_participant_non_allowed_number"),

            pytest.param("David", "Smith", "Analytics", "+380999999999", "david@example.com", "david#5678",
                         "https://www.linkedin.com/davidsmith", "New York", True, None, True, True, "Regular",
                         400,
            ...
            pytest.param("David", "Smith", "Analytics", "+380999999999", "david@example.com", "david#5678",
                         "https://www.linkedin.com/davidsmith", "New York", True, 1, True, True, 5,400,
