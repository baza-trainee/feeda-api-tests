...
class TestProjectAdminPanel:
    ...
    @pytest.mark.parametrize("title, comment, type_project, complexity, project_status, start_date_project,"
                             "end_date_project, address_site, status_code", data, ids=ids)
    def test_create_project(self, token, title, comment, type_project, complexity, project_status, start_date_project,
...
# Розібратись з кукі
    ...
    @pytest.mark.parametrize("first_name, last_name, email, project_type, complexity, status, title, comment,"
                             " start_date_project, end_date_project, address_site, status_code", data_for_update,
                             ids=ids_for_data_for_update)
    def test_update_project(self, project, token, first_name, last_name, email, project_type, complexity, status,
                            title, comment, start_date_project, end_date_project, address_site, status_code):
